...
{
    /// <summary>
    /// Wrapper for <see cref="Directory"/> class.
    /// </summary>
    public interface IDirectory
    {
        ...
        /// <returns>A <see cref="T:UnitWrappers.System.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control rules for the file described by the <param name="path"> parameter. </returns>
