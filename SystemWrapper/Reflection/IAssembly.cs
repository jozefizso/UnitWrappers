...
namespace SystemWrapper.Reflection
{
    ...
    public interface IAssembly : IEvidenceFactory, ICustomAttributeProvider, ISerializable
    {
        ...
        int GetHashCode();
        /// <summary>
        /// Gets an <see cref="T:SystemWrapper.Reflection.IAssemblyName"/> for this assembly. 
        /// </summary>
        /// <returns>An <see cref="T:SystemWrapper.Reflection.IAssemblyName"/> for this assembly. </returns>
        IAssemblyName GetName();
        /// <summary>
        /// Gets the <see cref="T:SystemWrapper.Reflection.IAssemblyName"/> objects for all the assemblies referenced by this assembly. 
        /// </summary>
