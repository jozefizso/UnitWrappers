...
namespace SystemWrapper.IO
{
    ...
    public interface IDirectory
    {
        ...
        /// <returns>A <see cref="T:SystemWrapper.IO.IDirectory"/> as specified by path.</returns>
        ...
        /// <returns>A <see cref="T:SystemWrapper.IO.IDirectory"/> object representing the newly created directory. </returns>
        ...
        /// <summary>
        /// Gets a <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control list (ACL) entries for a specified directory. 
        /// </summary>
        ...
        /// <returns>A <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control rules for the file described by the <param name="path"> parameter. </returns>
        ...
        /// <summary>
        /// Applies access control list (ACL) entries described by a <see cref="T:SystemWrapper.IO.IDirectory"/> object to the specified directory. 
        /// </summary>
        /// <param name="path">A directory to add or remove access control list (ACL) entries from.</param>
        /// <param name="directorySecurity">A <see cref="T:SystemWrapper.IO.IDirectory"/> object that describes an ACL entry to apply to the directory described by the path parameter.</param>
