...
namespace SystemWrapper.IO
{
    ...
    public interface IDirectoryInfo
    {
        ...
        /// <summary>
        /// A <see cref="T:SystemWrapper.IO.IDirectoryInfo"/> object representing the root of a path. 
        /// </summary>
        ...
        /// <summary>
        /// Gets a <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control list (ACL) entries for the directory described by the current DirectoryInfo object.
        /// </summary>
        /// <returns>A <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control rules for the directory.</returns>
        IDirectorySecurity GetAccessControl();
        /// <summary>
        /// Gets a <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the specified type of access control list (ACL) entries for the directory described by the current DirectoryInfo object. 
        /// </summary>
        ...
        /// <returns>A <see cref="T:SystemWrapper.Security.AccessControl.IDirectorySecurity"/> object that encapsulates the access control rules for the file described by the path parameter.</returns>
        IDirectorySecurity GetAccessControl(AccessControlSections includeSections);
        /// <summary>
        /// Returns the subdirectories of the current directory.
        /// </summary>
        /// <returns>An array of <see cref="T:SystemWrapper.IO.IDirectoryInfo"/> objects. </returns>
        ...
        /// <returns>An array of type <see cref="T:SystemWrapper.IO.IFileInfo"/>.</returns>
